...
function setup() {
  ...
  graphics = create.
  let step = width / (wallCount + 1); // Spacing between vertical walls
...
function draw() {
  ...
  // Blinking text
  if (frameCount % 60 < 30) { // Blinks at ~1Hz (30 frames on, 30 frames off)
    fill(255, 255, 255); // Yellow color
    textSize(32); // Font size
    textAlign(CENTER, CENTER); // Center alignment
    text("Click in the middle to start", width / 2, height/8);
  }
}
